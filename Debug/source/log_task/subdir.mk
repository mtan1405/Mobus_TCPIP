...
C_SRCS += \
../source/log_task/task_log.c 

C_DEPS += \
./source/log_task/task_log.d 

OBJS += \
./source/log_task/task_log.o 


# Each subdirectory must supply rules for building sources it contributes
source/log_task/%.o: ../source/log_task/%.c source/log_task/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-log_task

clean-source-2f-log_task:
	-$(RM) ./source/log_task/task_log.d ./source/log_task/task_log.o

.PHONY: clean-source-2f-log_task
